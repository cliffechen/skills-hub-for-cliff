...
`web_signal_analysis.json` 由 web-signal-analyst 负责生成，本阶段只负责把它合并进：

- `chapters.ch07_web_signal_intelligence`
- `excel_sheets.Web情报_搜索结果`
- `excel_sheets.Web情报_抓取明细`
- `excel_sheets.Web情报_综合洞察`
...
- 如果启用 xCrawl，所有 Web 情报 Sheet 必须在 `数据来源说明` 中标明来源为 xCrawl MCP / xCrawl API
